...
router.get("/title/:title", movies.findByTitle); // Retrieve a single movie with title
router.get("/genre/:genre", movies.findByGenre); // Retrieve movies with genre
router.get("/language/:original_language", movies.findByLang); // Retrieve movies with language
